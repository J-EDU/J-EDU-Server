...
router.post('/addQuiz',__isAuth,__isBlocked,__addQuiz);
router.delete('/deleteQuiz/:id',__isAuth,__isBlocked,__deleteQuiz );
router.put('/updateQuiz/:id',__isAuth,__isBlocked,__updateQuiz );
